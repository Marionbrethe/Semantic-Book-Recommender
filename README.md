...
# Key Concepts
Hybrid Filtering - This system solves two common problems:  
(1) Embeddings are too literal: Embeddings might suggest a book just because it shares keywords, even if the writing style is bad. The LLM Reranker fixes this by evaluating quality.  
(2) LLMs hallucinate: LLMs might invent books. The Open Library Validation step ensures every recommendation exists and has a valid ISBN.  
